...
import DefaultNavbarDropdown from '@/mui/shared/Navbars/DefaultNavbar/DefaultNavbarDropdown';
import DefaultNavbarMobile from '@/mui/shared/Navbars/DefaultNavbar/DefaultNavbarMobile';
...
function DefaultNavbar({
  ...
  useEffect(closeMobileNavbar, [router.asPath]);


  const renderNavbarItems = routes && routes.map(
    ({ name, icon, href, route, children }: any) => (
      <DefaultNavbarDropdown
        key={name}
        name={name}
        icon={Boolean(children && children.length)
          ? true
          : false}
        href={
  ...
  const renderNestedRoutes = routes && routes.map(
